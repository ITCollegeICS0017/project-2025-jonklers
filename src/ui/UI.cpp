...
void UI::bidLeaf(std::string method, std::shared_ptr<Listing> listing, std::shared_ptr<Menu> menu) {
    ...
    bool res = logic.place_bid(std::dynamic_pointer_cast<Auction>(listing), method, price); // TODO: make sure logic implements payment method
...
void UI::negotiateLeaf(std::string method, std::shared_ptr<Listing> listing, std::shared_ptr<Menu> menu) {
    ...
    bool res = logic.negotiate(std::dynamic_pointer_cast<Negotiation>(listing), method, price); // TODO: make sure logic implements payment method
